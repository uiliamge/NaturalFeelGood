...
namespace Application.Features.Symptoms.Queries
{
    /// <summary>
    /// Provides a query to get symptom dropdown data.
    /// </summary>
    public static class GetSymptomDropdown
    {
        ...
        public class Handler : IRequestHandler<Query, List<BaseDropdownDto>>
        {
            ...
            public Handler(ISymptomRepository repository, ILanguageContext languageContext)
            {
