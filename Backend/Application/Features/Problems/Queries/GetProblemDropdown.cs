...
namespace Application.Features.Problems.Queries
{
    /// <summary>
    /// Provides a query to get problem dropdown data.
    /// </summary>
    public static class GetProblemDropdown
    {
        ...
        public class Handler : IRequestHandler<Query, List<BaseDropdownDto>>
        {
            ...
            public Handler(IProblemRepository repository, ILanguageContext languageContext)
            {
