...
namespace NaturalFeelGood.API.Controllers
{
    ...
    public class ElementTypeController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post([FromBody] CreateElementTypeDto dto)
        {
            ...
            var command = new CreateElementTypeCommand { ElementType = element };
        ...
        public async Task<IActionResult> Put(string id, [FromBody] UpdateElementTypeDto dto)
        {
            ...
            var updatedElement = _mapper.Map<Domain.Entities.ElementType>(dto);
            updatedElement.Id = id;
            var command = new UpdateElementTypeCommand { Id = id, UpdatedElementType = updatedElement };
            await _mediator.Send(command);
            return NoContent();
        }
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            var command = new DeleteElementTypeCommand { Id = id };
            await _mediator.Send(command);
            return NoContent();
        }
